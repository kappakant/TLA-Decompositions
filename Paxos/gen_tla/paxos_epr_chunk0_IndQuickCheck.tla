---- MODULE paxos_epr_chunk0_IndQuickCheck ----
...
kCTIs == 
	\/ /\ left_rnd = {<<a1, 1>>, <<a2, 0>>, <<a2, 1>>} /\ one_a = {} /\ one_b = { {<<a1, 1>>, <<a2, 1>>, <<a3, 0>>},   {<<a2, 0>>, <<a2, 1>>, <<a3, 1>>},   {<<a1, 0>>, <<a1, 1>>, <<a2, 0>>, <<a2, 1>>, <<a3, 1>>} } /\ one_b_max_vote = { <<a1, 0, 1, v2>>,   <<a1, 1, 1, v2>>,   <<a2, 0, 0, v1>>,   <<a2, 0, 0, v2>>,   <<a2, 0, 1, v1>>,   <<a2, 0, 1, v2>>,   <<a2, 1, 0, v1>>,   <<a2, 1, 0, v2>>,   <<a3, 0, 1, v1>>,   <<a3, 0, 1, v2>>,   <<a3, 1, 0, v2>>,   <<a3, 1, 1, v2>> } /\ decision = {<<a1, 1, v1>>, <<a2, 0, v1>>, <<a2, 1, v1>>, <<a3, 1, v1>>} /\ vote = {<<a1, 0, v1>>, <<a2, 1, v1>>, <<a3, 0, v2>>} /\ proposal = {<<0, v2>>, <<1, v1>>, <<1, v2>>}
	   /\ ctiId = "8491587577420832192"
