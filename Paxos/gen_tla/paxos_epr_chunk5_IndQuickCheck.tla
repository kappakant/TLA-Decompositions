---- MODULE paxos_epr_chunk5_IndQuickCheck ----
...
kCTIs == 
	\/ /\ left_rnd = {<<a3, 0>>, <<a3, 1>>} /\ one_a = {} /\ one_b = {{<<a1, 0>>, <<a1, 1>>, <<a3, 0>>, <<a3, 1>>}} /\ one_b_max_vote = { <<a1, 1, 0, v1>>,   <<a2, 0, 0, v1>>,   <<a2, 0, 1, v1>>,   <<a2, 0, 1, v2>>,   <<a3, 0, 0, v1>>,   <<a3, 0, 1, v1>>,   <<a3, 1, 0, v2>>,   <<a3, 1, 1, v1>>,   <<a3, 1, 1, v2>> } /\ decision = {<<a2, 0, v2>>, <<a2, 1, v2>>, <<a3, 0, v2>>} /\ vote = {<<a1, 1, v1>>, <<a1, 1, v2>>, <<a2, 0, v2>>, <<a2, 1, v2>>, <<a3, 1, v2>>} /\ proposal = {<<0, v2>>, <<1, v1>>, <<1, v2>>}
	   /\ ctiId = "5407428005392651866"
