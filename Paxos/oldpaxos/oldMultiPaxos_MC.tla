...
EXTENDS MultiPaxos, Randomization
...
NumRandElems == 6
TypeOKRandom == /\ \A m \in msgs: m \in RandomSubset(NumRandElems, Messages)
                /\ \A r \in Replicas: node[r] \in RandomSubset(NumRandElems, NodeStates)
