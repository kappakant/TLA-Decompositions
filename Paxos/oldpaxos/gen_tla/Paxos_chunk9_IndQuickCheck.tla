---- MODULE Paxos_chunk9_IndQuickCheck ----
...
kCTIs == 
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 2) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "2b", bal |-> 1, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 2)
	   /\ ctiId = "-8298769054915529074"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "1060828825857695378"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a3, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-163023495340112232"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = {[type |-> "1a", bal |-> 0], [type |-> "1a", bal |-> 2]} /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "7468177931853598362"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "5439722958588024474"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "2693621273188794020"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 0, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> v1] } /\ maxBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0)
	   /\ ctiId = "-5230537220969552220"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "2885615203685447341"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 2)
	   /\ ctiId = "2708723385775077043"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "6741218413679451833"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-3047039241990832448"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-2762857316675002681"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 0)
	   /\ ctiId = "-1195104386652469561"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 0 @@ a3 :> -1)
	   /\ ctiId = "7295210028590325450"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = {[type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1]} /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "4746169319276353230"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 2)
	   /\ ctiId = "-325662619669506338"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = {[type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2]} /\ maxBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "1053600500391507681"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v1],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "4902593182689736433"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-5540236323359422730"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 2, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-6819287564185766151"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1)
	   /\ ctiId = "100819279856819966"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = {[type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 2, mval |-> None]} /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-8779797439095914750"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = {[type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1]} /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-7696678676532418812"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "2a", bal |-> 0, val |-> v1],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-7691776500778746106"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 2)
	   /\ ctiId = "-1300786308202866915"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-7376550606662695139"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "1525006692277868317"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-3345319949403076835"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-6973480930070513887"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 2 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-6246548405823721691"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "2a", bal |-> 0, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-6098931520737300694"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a3, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "6628191741569285932"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "6997790574356152112"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> -1)
	   /\ ctiId = "7681616491621648177"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = {[type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None]} /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-7312805535851763917"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-250657245679737036"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "7763953056665302838"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "3383940362627077943"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "2a", bal |-> 0, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "2403584738807672633"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "3720547371199305529"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 1, val |-> v1],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "8554550891883153215"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "2737810468209678155"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-1647811382517452980"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-221453506448769197"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "6545956191880118100"
