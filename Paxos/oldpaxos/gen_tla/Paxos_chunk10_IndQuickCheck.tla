---- MODULE Paxos_chunk10_IndQuickCheck ----
...
kCTIs == 
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-7356833440075569323"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "6851593721582878551"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 0, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-3511417281782544552"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "8197664469762314076"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a3, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "5003638699738840931"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 2)
	   /\ ctiId = "1258385804953442149"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "2a", bal |-> 0, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-5795010474086463642"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "4452533165815215977"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "5680594043248680815"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v1],   [type |-> "2b", bal |-> 2, acc |-> a3, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "2968758196856149879"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 1, val |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "5436521891606902648"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "-6126530926785781895"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 2)
	   /\ ctiId = "-8594913980350435462"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-7302474562650593413"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "6390531310279706492"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-4941808477478320260"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 0, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 2)
	   /\ ctiId = "570192849913380735"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-7934557202933985408"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "912156280014806922"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "6551000136431454095"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> -1)
	   /\ ctiId = "7129260484383858583"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "6405075623854307223"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a3, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-2568408287045185639"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = {[type |-> "1a", bal |-> 1], [type |-> "1a", bal |-> 2]} /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "6093875677233184670"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "8659814983553963936"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = {[type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None]} /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-1989121414023710816"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-750602066873288793"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-8727328141088055384"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "-6235317432082524249"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v1] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-8846632125536084055"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> -1)
	   /\ ctiId = "6974984006960654251"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "1539470727738986414"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> -1 @@ a3 :> 0)
	   /\ ctiId = "-7881223263242758226"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 2)
	   /\ ctiId = "4220066577480181683"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "7976170891452688317"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-7620113555762337857"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1) /\ msgs = {} /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-4917054485503244347"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "7977621501496559565"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 0)
	   /\ ctiId = "-2546082782963468337"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> v1] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "2544628293380237267"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 2 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "8898676251216908257"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 1, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-5736036013835927580"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "-7163821993296441368"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-6563606513183070230"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "-4665758177823217683"
