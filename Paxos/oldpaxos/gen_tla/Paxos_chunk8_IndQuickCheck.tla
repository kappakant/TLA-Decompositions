---- MODULE Paxos_chunk8_IndQuickCheck ----
...
kCTIs == 
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-4827572475478665790"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = {} /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-7050857219688319548"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-2768105549206958646"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "4624245054472220108"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-7090419342631490096"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-7153268562271212077"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "7737302785485950420"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> v1] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-1004146339459525162"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "2a", bal |-> 0, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-6889671861974989354"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-4062113148340068905"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v1],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "3315042261354685912"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-4326258326439047715"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-6717906223518564891"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-3130450594271906328"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = {[type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> None]} /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-5262478628029121048"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "8228981642512762347"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-4000186273514822164"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> -1 @@ a3 :> 0)
	   /\ ctiId = "-6044654417692142098"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-5603357432696758792"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "8968006295732610557"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "860947747251125761"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-5943880865896841720"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "6664869589767683597"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 2)
	   /\ ctiId = "-2039501191585503724"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "1801288511455354389"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-1961038930774741480"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "-7330078094096796132"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-2521236640251615712"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-8700730356569639379"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 2) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "2b", bal |-> 1, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 2)
	   /\ ctiId = "9117018555392945710"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-5470666845088600526"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-966287991465046475"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "2a", bal |-> 0, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-417686610919244229"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = {} /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "6676950548836306497"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2a", bal |-> 0, val |-> v2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "-4006068961830728120"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "8243544402097638993"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "2a", bal |-> 0, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "2315885604472440412"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 0, val |-> v2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "-8629970111762799011"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-5243453781988657572"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> -1)
	   /\ ctiId = "8037257993726946914"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-8838080201218851229"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> -1) /\ msgs = { [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> -1)
	   /\ ctiId = "7285109435453687414"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-5856322065031340423"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "1537930723721442949"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "808843496050478727"
