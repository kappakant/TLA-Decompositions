---- MODULE Paxos_chunk2_IndQuickCheck ----
...
kCTIs == 
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-5850411637517016746"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "2243033398256482647"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = {[type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v1]} /\ maxBal = (a1 :> 2 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "-1744997095155039912"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "5184111318155940183"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "2575375137903180122"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "-7617995590639740587"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a3, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "4223175353121759590"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "-5425735714853566099"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "2a", bal |-> 1, val |-> v1],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-58761484561491598"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "-6765878733089216141"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "8625946105668374900"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = {[type |-> "1a", bal |-> 1]} /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "2084122013170862450"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a3, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "7107069745483344251"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-5955712263562464897"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 1, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-4035379180883895934"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "3165356245097601411"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "8945755005190861190"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "422227692368691595"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1) /\ msgs = { [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-3271267623084279408"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v1],   [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "3396584754906243475"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-7738401139712366189"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "5057475425696170387"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "2a", bal |-> 0, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "1678146752874277270"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 1, val |-> v1],   [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-3887681910384578153"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "3283330487879586199"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = {[type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2]} /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "1957410102910656917"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "352469539333730714"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 0 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "3644589416377616803"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "-7175469199286603355"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 0, val |-> v2],   [type |-> "2b", bal |-> 0, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a3, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-2024796280648351316"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "1762108873247160756"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-3852465367473851970"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0)
	   /\ ctiId = "5946737026704679361"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "2b", bal |-> 1, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "6948137207217703362"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a1, mbal |-> 2, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "8265696235455803841"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> 1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 0)
	   /\ ctiId = "-6454897624886754875"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 2],   [type |-> "2b", bal |-> 2, acc |-> a1, val |-> v2],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-7283456099056531001"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> 0 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "6686465896125288910"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> None) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> -1) /\ msgs = { [type |-> "2b", bal |-> 0, acc |-> a2, val |-> v2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 1 @@ a2 :> 2 @@ a3 :> -1)
	   /\ ctiId = "8938732327932772816"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 0, acc |-> a2, mbal |-> 1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a1, mbal |-> -1, mval |-> v1] } /\ maxBal = (a1 :> 2 @@ a2 :> 0 @@ a3 :> 1)
	   /\ ctiId = "8249631216090362320"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 1],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 0, acc |-> a3, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> -1 @@ a2 :> 2 @@ a3 :> 1)
	   /\ ctiId = "-3099361293073002031"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 1) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 2, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> -1 @@ a3 :> 1)
	   /\ ctiId = "-7836190618277922348"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 1)
	   /\ ctiId = "1202961977753719255"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> -1 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> 0, mval |-> None] } /\ maxBal = (a1 :> 1 @@ a2 :> 1 @@ a3 :> 0)
	   /\ ctiId = "-2780137577465382441"
	\/ /\ maxVal = (a1 :> None @@ a2 :> None @@ a3 :> v1) /\ maxVBal = (a1 :> -1 @@ a2 :> 0 @@ a3 :> 0) /\ msgs = { [type |-> "1a", bal |-> 0],   [type |-> "1a", bal |-> 2],   [type |-> "2a", bal |-> 2, val |-> v1],   [type |-> "1b", bal |-> 1, acc |-> a2, mbal |-> -1, mval |-> v1],   [type |-> "1b", bal |-> 2, acc |-> a1, mbal |-> -1, mval |-> None],   [type |-> "1b", bal |-> 2, acc |-> a2, mbal |-> -1, mval |-> v2],   [type |-> "1b", bal |-> 2, acc |-> a3, mbal |-> -1, mval |-> v2] } /\ maxBal = (a1 :> 2 @@ a2 :> 2 @@ a3 :> 0)
	   /\ ctiId = "-1963077069831419430"
