---- MODULE a_hist_TTrace_1753792330 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("a_hist_TTrace_1753792330.json", _TETrace)
...
\*
\*trace == IODeserialize("a_hist_TTrace_1753792330.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG a_hist_TTrace_1753792330 ----
CONSTANTS
    NODE = { 1 , 2 , 3 }
    DATA = { 1 , 2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 29 08:32:10 EDT 2025