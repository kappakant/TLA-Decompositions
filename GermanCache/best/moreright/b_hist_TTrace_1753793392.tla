---- MODULE b_hist_TTrace_1753793392 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("b_hist_TTrace_1753793392.json", _TETrace)
...
\*
\*trace == IODeserialize("b_hist_TTrace_1753793392.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG b_hist_TTrace_1753793392 ----
CONSTANTS
    NODE = { 1 , 2 , 3 }
    DATA = { 1 , 2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 29 08:49:52 EDT 2025