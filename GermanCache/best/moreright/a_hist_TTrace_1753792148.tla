---- MODULE a_hist_TTrace_1753792148 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("a_hist_TTrace_1753792148.json", _TETrace)
...
\*
\*trace == IODeserialize("a_hist_TTrace_1753792148.bin", TRUE)
\*
\*=============================================================================
\*
...
trace == 
    ...
    ([Chan2 |-> <<<<"Empty", 1>>, <<"Empty", 1>>, <<"Empty", 1>>>>,ExGntd |-> FALSE,Chan3 |-> <<<<"Empty", 1>>, <<"Empty", 1>>, <<"Empty", 1>>>>,MemData |-> 1,AuxData |-> 1,Cache |-> <<<<"S", 1>>, <<"I", 1>>, <<"I", 1>>>>]),
    ([Chan2 |-> <<<<"Empty", 1>>, <<"GntE", 1>>, <<"Empty", 1>>>>,ExGntd |-> TRUE,Chan3 |-> <<<<"Empty", 1>>, <<"Empty", 1>>, <<"Empty", 1>>>>,MemData |-> 1,AuxData |-> 1,Cache |-> <<<<"S", 1>>, <<"I", 1>>, <<"I", 1>>>>]),
...
---- CONFIG a_hist_TTrace_1753792148 ----
CONSTANTS
    NODE = { 1 , 2 , 3 }
    DATA = { 1 , 2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 29 08:29:08 EDT 2025