---- MODULE ab_chunk0_IndQuickCheck ----
...
kCTIs == 
	\/ /\ CurCmd = "GntS" /\ ExGntd = TRUE /\ CurPtr = 2 /\ InvSet = <<TRUE, FALSE, TRUE>> /\ AuxData = 2 /\ MemData = 2 /\ Chan1 = <<<<"ReqS", 2>>, <<"ReqS", 1>>, <<"InvAck", 2>>>> /\ Chan2 = <<<<"GntS", 2>>, <<"InvAck", 1>>, <<"ReqS", 1>>>> /\ Chan3 = <<<<"GntE", 1>>, <<"ReqE", 2>>, <<"InvAck", 1>>>> /\ Cache = <<<<"I", 2>>, <<"S", 2>>, <<"I", 1>>>> /\ ShrSet = <<TRUE, FALSE, FALSE>>
	   /\ ctiId = "1318712648484158176"
