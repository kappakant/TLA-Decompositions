---- MODULE ab_chunk1_IndQuickCheck ----
...
kCTIs == 
	\/ /\ CurCmd = "Inv" /\ ExGntd = FALSE /\ CurPtr = 1 /\ InvSet = <<FALSE, TRUE, FALSE>> /\ AuxData = 2 /\ MemData = 2 /\ Chan1 = <<<<"ReqS", 2>>, <<"Empty", 1>>, <<"Inv", 2>>>> /\ Chan2 = <<<<"ReqE", 1>>, <<"Empty", 1>>, <<"ReqS", 2>>>> /\ Chan3 = <<<<"GntS", 1>>, <<"InvAck", 1>>, <<"ReqE", 1>>>> /\ Cache = <<<<"I", 1>>, <<"E", 2>>, <<"I", 2>>>> /\ ShrSet = <<TRUE, TRUE, FALSE>>
	   /\ ctiId = "4743594287235843657"
