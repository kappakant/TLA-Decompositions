---- MODULE b_hist_TTrace_1753792152 ----
...
\* to `JsonSerialize`. For example, a sub-sequence of _TETrace.
    \* ASSUME
    \*     LET J == INSTANCE Json
    \*         IN J!JsonSerialize("b_hist_TTrace_1753792152.json", _TETrace)
...
\*
\*trace == IODeserialize("b_hist_TTrace_1753792152.bin", TRUE)
\*
\*=============================================================================
\*
...
---- CONFIG b_hist_TTrace_1753792152 ----
CONSTANTS
    NODE = { 1 , 2 , 3 }
    DATA = { 1 , 2 }
...
ALIAS
    _expression
=============================================================================
\* Generated on Tue Jul 29 08:29:12 EDT 2025
