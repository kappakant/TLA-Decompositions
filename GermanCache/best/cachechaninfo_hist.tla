--------------------------- MODULE cachechaninfo_hist ---------------------------
EXTENDS Naturals, Integers, Sequences, FiniteSets, TLC, Randomization

CONSTANTS NODE, DATA

VARIABLES Chan2, ExGntd, Chan3, MemData, AuxData, Chan1, Cache

vars == <<Chan2, ExGntd, Chan3, MemData, AuxData, Chan1, Cache>>
...
/\ UNCHANGED <<Cache,Chan1,Chan3,ExGntd,MemData,AuxData>>
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ UNCHANGED <<Chan1,ExGntd,MemData,AuxData>>
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ UNCHANGED <<Cache,Chan1,ExGntd,MemData,AuxData>>
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ ExGntd' = FALSE
/\ MemData' = Chan3[i][2]
/\ UNCHANGED <<Cache,Chan1,Chan2,AuxData>>
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ Chan3' = [Chan3 EXCEPT![i] = <<"Empty",Chan3[i][2]>>]
/\ ExGntd = FALSE
/\ UNCHANGED <<Cache,Chan1,Chan2,ExGntd,MemData,AuxData>>
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ ExGntd' = TRUE
/\ UNCHANGED <<Cache,Chan1,Chan3,MemData,AuxData>>
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ Chan2' = [Chan2 EXCEPT![i] = <<"Empty",Chan2[i][2]>>]
/\ UNCHANGED <<Chan1,Chan3,ExGntd,MemData,AuxData>>
/\ UNCHANGED<<>>
/\ CandSep'
...
/\ AuxData' = d
/\ UNCHANGED <<Chan1,Chan2,Chan3,ExGntd,MemData>>
/\ UNCHANGED<<>>
/\ CandSep'
