...
vars == <<Chan1, InvSet, ShrSet, ExGntd, CurCmd, CurPtr, MemData, AuxData>>
...
SendReqS(i) ==
    ...
    /\ UNCHANGED <<InvSet, ShrSet, ExGntd, CurCmd, CurPtr, MemData, AuxData>>
...
RecvReqS(i) ==
    ...
    /\ UNCHANGED <<ShrSet, ExGntd, MemData, AuxData>>
...
SendInv(i) ==
    ...
    /\ UNCHANGED <<Chan1, ShrSet, ExGntd, CurCmd, CurPtr, MemData, AuxData>>
...
RecvInvAck(i) ==
    ...
    /\ IF ExGntd = TRUE
       ...
       ELSE /\ UNCHANGED ExGntd
            /\ UNCHANGED MemData
    /\ UNCHANGED <<Chan1, InvSet, CurCmd, CurPtr, AuxData>>
...
SendGntS(i) ==
    ...
    /\ CurCmd' = "Empty"
    /\ UNCHANGED <<Chan1, InvSet, CurPtr, ExGntd, MemData, AuxData>>
...
SendGntE(i) ==
    ...
    /\ ExGntd' = TRUE
    /\ CurCmd' = "Empty"
    /\ UNCHANGED <<Chan1, InvSet, CurPtr, MemData, AuxData>>
